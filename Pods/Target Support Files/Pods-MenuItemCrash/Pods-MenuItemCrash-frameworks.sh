...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/PLCrashReporter/Mac OS X Framework/CrashReporter.framework"
  install_dsym "${PODS_ROOT}/PLCrashReporter/Mac OS X Framework/CrashReporter.framework.dSYM"
fi
